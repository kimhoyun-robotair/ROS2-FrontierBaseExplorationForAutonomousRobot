...
with open("/home/kimhoyun/DARAM-G/src/ROS2-FrontierBaseExplorationForAutonomousRobot/autonomous_exploration/config/params.yaml", 'r') as file:
...
class navigationControl(Node):
    ...
    def map_callback(self,msg):
        ...
        remapped[(data>=0) & (data<=60)] = 0
        remapped[(data> 60) & (data<=100)] = 100
